...
This file is the training file for the SKLearn Multi-Layer Perceptron (MLP) Neural Network.  This file imports image
files of circles, rectangles, squares, and triangles and outputs a neural network that can predict the classification
of a drawn shape into one of the four aforementioned groups.
...
2. A pkl file for the SKLearn MLP neural network object used for classifying new drawn images into 1 of 4 classes
3. A txt file identifying the metrics of the MLP model (training set size and model outputs)
'''
...
file = open('ModelOutput_SKL.txt', 'w+')
...
file = open('ModelOutput_SKL.txt', 'a+')
